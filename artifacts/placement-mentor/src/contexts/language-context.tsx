...
const translations: Record<Lang, T> = {
  en: {
    ...
    hero_badge: "1,200+ students placed this year from Tier-2, Tier-3 & Degree colleges",
    hero_heading: "Your AI Placement Mentor for",
    hero_headingAccent: "Career Success",
    hero_desc: "From Tier-2, Tier-3 or Degree college to top tech company — get a personalized roadmap, AI mock interviews, and real mentorship to become placement-ready in 90 days.",
    ...
    success_heading: "From Tier-2, Tier-3 & Degree Colleges to Top Tech",
    ...
    footer_tagline: "The career mentor that Tier-2, Tier-3 & Degree college students never had. Built with ❤️ for every Indian student.",
